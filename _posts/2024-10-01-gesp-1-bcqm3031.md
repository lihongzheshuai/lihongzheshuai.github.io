...
没想到这道题对我孩子的难点居然是不知道什么是8折，小朋友确实没自己买过什么东西。8折就是：_价格 _ 0.8\*。知道这个关系剩下就是简单的计算和按格式输出了。浮点数格式化***%m.nf***知识点，已在[BCQM3027](https://www.coderli.com/gesp-1-bcqm3027/)中详细介绍，不再赘述。
