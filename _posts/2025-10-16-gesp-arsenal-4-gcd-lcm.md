...
手动实现的理论，是基于欧几里得算法和最大公约和最小公倍的基础公式，这部分内容已在文章([**_【GESP】C++五级考试大纲知识点梳理, (1) 初等数论_**](https://www.coderli.com/gesp-5-exam-syllabus-elementary-number-theory/))中详细介绍过。这里就不再赘述。下面直接给出代码的具体实现。
