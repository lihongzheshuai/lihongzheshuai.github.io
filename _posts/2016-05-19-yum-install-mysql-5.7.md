...
在目录**/etc/yum.repos.d/**下新建**mysql-community.repo**文件，内容如下：
...
在**/etc/pki/rpm-gpg/** 目录下新建**RPM-GPG-KEY-mysql** 文件，从MySQL5.7的官方文档(http://dev.mysql.com/doc/refman/5.7/en/checking-gpg-signature.html)拷贝如下Key内容至该文件：
...
```bash
gpg --import /etc/pki/rpm-gpg/RPM-GPG-KEY-mysql
