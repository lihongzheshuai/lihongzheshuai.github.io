...
稍微增加了一点点难度，输入后，根据题目要求进行计算，然后按要求输出结果。即跟之前的题([**_BCQM3017-3018_**](https://www.coderli.com/gesp-1-bcqm3017-3018/))比起来多了计算环节，计算就小学应用题水平。
...
> 已知一位小朋友电影票价是10元，计算 **_x_** 位小朋友的总票价是多少？
